...
const LandingPage = () => {
 ...
 return (
   <>
  <Helmet>
    <title>Refem | LandingPage</title>
    <meta name="description" content="Refem" />
           ...
           <div className="hero-inner">
             <div className="hero-copy">
               <h1 className="hero-title mt-0 is-revealing">
                 Get Your Resume to Your Employer
               </h1>
               <p className="hero-paragraph is-revealing">
                    *REFEM, short for résumé-followup-email-manager is an app that
                    allows you to send potential employers (maybe the recruiters), a followup email
                    just to remind them that you are still interested in the Job in Question.
                </p>
               <div className="hero-form field field-grouped is-revealing">
                 <div className="control">
                   <a className="button button-primary button-block enlarge-btn" href="/login">
                     Get Started
                   </a>
                 </div>
               </div>
               ...
               <div className="feature">
                 <div className="feature-inner">
                   <div className="feature-header mb-16">
                     ...
                     <h4 className="feature-title m-0">Free API calls</h4>
                   </div>
               ...
               <div className="feature">
                 <div className="feature-inner">
                   <div className="feature-header mb-16">
                     ...
                     <h4 className="feature-title m-0">Attach Resume</h4>
                   </div>
                   <p className="text-sm mb-0">
                      Attaching a copy of your resume to your email will give
                      your potential employer the easy-access to re-evaluate your skills on the Job
                      in Question. 
                    </p>
                 </div>
               </div>
               <div className="feature">
                 <div className="feature-inner">
                   <div className="feature-header mb-16">
                     ...
                     <h4 className="feature-title m-0">Documentation</h4>
                   </div>
                   <p className="text-sm mb-0">
       ...
       <div className="container">
         <div className="site-footer-inner has-top-divider">
           <div className="footer-copyright">
             © 2021 Lucky Pius, all rights reserved
           </div>
           <ul className="footer-social-links list-reset">
             <li>
               <a target="_blank" rel="noreferrer" href="https://github.com/PiusLucky/REFEM">
